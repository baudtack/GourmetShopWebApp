...
public partial class GourmetShopContext : IdentityDbContext<GourmetShopUser>
{
    public GourmetShopContext()
    {
    }

    public GourmetShopContext(DbContextOptions<GourmetShopContext> options)
        : base(options)
    {
    }
